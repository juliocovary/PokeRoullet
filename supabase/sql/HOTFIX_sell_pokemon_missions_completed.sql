-- Run this directly in Supabase SQL Editor if sell_pokemon is failing with:
-- code 42703: column "missions_completed" does not exist
...
BEGIN
  ...
  -- Critical fix: do not select specific output columns from update_mission_progress.
