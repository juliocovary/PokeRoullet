-- HOTFIX: evolve_pokemon fails with "column missions_completed does not exist"
-- Run this script directly in Supabase SQL Editor for immediate fix.
...
BEGIN
  ...
  -- Avoid column-name coupling from update_mission_progress return signature.
