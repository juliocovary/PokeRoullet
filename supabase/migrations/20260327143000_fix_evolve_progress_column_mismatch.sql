-- Fix evolve_pokemon runtime error caused by outdated column names from update_mission_progress.
-- Some environments return completed_missions (not missions_completed).
-- Use PERFORM to avoid coupling with return column names.
...
BEGIN
  ...
  -- Do not destructure function result columns: schema can vary by environment.
