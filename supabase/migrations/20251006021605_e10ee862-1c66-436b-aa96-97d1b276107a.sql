-- Create function to handle pokemon evolution
...
BEGIN
  ...
  -- Check if user has enough cards of base pokemon
  SELECT quantity INTO current_quantity
  FROM public.pokemon_inventory
  WHERE user_id = p_user_id AND pokemon_id = p_base_pokemon_id;
  ...
  -- Add evolved pokemon to inventory
  INSERT INTO public.pokemon_inventory (user_id, pokemon_id, pokemon_name, rarity, quantity)
  VALUES (p_user_id, p_evolved_pokemon_id, p_evolved_pokemon_name, p_evolved_pokemon_rarity, 1)
