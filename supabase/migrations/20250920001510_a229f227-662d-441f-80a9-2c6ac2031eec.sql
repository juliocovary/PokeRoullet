-- Create function to sell pokemon
...
BEGIN
  -- Get current quantity and rarity
  SELECT quantity, rarity INTO current_quantity, pokemon_rarity
  ...
  -- Check if it's a starter pokemon
  SELECT EXISTS(
