...
-- Insert new clan collective mission: Trainer enemies defeated (highest reward)
INSERT INTO clan_collective_missions (title, description, mission_type, frequency, goal, reward_clan_points, reward_member_coins, reward_member_shards, reward_member_spins)
VALUES (
  'Dominadores de Arena',
  'Derrote inimigos no Modo Treinador como clã',
  'trainer_enemies_defeated',
  'weekly',
  1000,
  750,
  300,
...
-- Update add_clan_points to handle the new trainer_enemies_defeated mission type
...
BEGIN
  ...
  -- Map activity_type to mission_type (now includes trainer_enemies_defeated)
