-- Primeiro, transferir os itens que foram dados erroneamente para os IDs corretos
UPDATE user_items SET item_id = 50 WHERE item_id = 1;
UPDATE user_items SET item_id = 51 WHERE item_id = 2;
UPDATE user_items SET item_id = 52 WHERE item_id = 4;
UPDATE user_items SET item_id = 53 WHERE item_id = 5;

-- Agora deletar os itens duplicados que eu criei
DELETE FROM items WHERE id IN (1, 2, 4, 5);

-- Atualizar a função claim_launch_event_rewards para usar os IDs corretos
