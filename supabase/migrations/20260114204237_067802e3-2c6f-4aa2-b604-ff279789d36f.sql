...
-- Fix: Get free_spins from user_spins table, not profiles
...
BEGIN
    ...
    -- Filter by selected rarity, with fallback to lower rarities
    ...
    -- Decrement free spins in user_spins table (not profiles!)
    UPDATE user_spins
